...
var tm_boss_info = {
    1808: [
        ['Moria', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Hancock', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Kuma', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        [['Dofla', 'mingo'], '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Mihawk', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    ],
    1853: [
        ['Marco', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Jozu', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Vista', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Ace', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['WB', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    ],
    1889: [
        ['Law', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Tashigi', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Sabo', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Bonney', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Cavendish', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    ],
    1916: {
        1364: ['Franky',  0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1532: ['Usopp', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1549: ['Robin', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1921: ['Zoro', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1916: ['Gear 4', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    1941: {
         410: ['Jinbe', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
         645: ['Whitey Bay', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1222: ['Oars Jr', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1851: ['Squard', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1941: ['Ace',  4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    1972: {
        1404: ['Luffy',  3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1467: ['Cavendish', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1536: ['Duval', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1926: ['Coby', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1972: ['Sabo',  4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2000: {
         265: [['Meppo & ', 'Coby'], 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1491: [['Mr. 5 & ', 'Ms. Val'], 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1543: [['Usopp & ', 'Chopper'], 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1759: [['Brook & ', 'Pedro'], 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2000: [['Sanji & ', 'Zoro'], 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2064: {
         459: ['Sengoku', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
         611: ['Purinpurin', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1423: ['T-Bone', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1983: [['Smoker & ', 'Tashigi'], 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2064: ['Kizaru', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    '2064_jpn': [
        ['Sengoku', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['T-Bone', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        [['Smoker & ', 'Tashigi'], '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Purinpurin', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        ['Kizaru', '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    ],
    2109: {
        2065: ['Pudding', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2076: ['Nami', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2080: ['Brook', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2082: ['Pedro', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1815: ['Sanji', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2109: ['Big Mom', 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2137: {
         257: ['Izo', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1245: ['Luffy', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1806: ['Buggy', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1849: ['Akainu', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2137: ['Croc', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2175: {
        1716: ['Caesar', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1880: ['Hody', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1895: ['Urouge', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2111: ['Kid', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2175: ['Jack', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2211: {
         463: ['Satori', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1197: ['Ohm', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1253: ['Shura', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1341: ['Gedatsu', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2211: ['Eneru', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2261: {
         777: ['Lucky Roux',  0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2046: ['Yasopp', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2256: ['Mihawk', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2257: ['Ace', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1770: ['Beckman', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2261: ['Shanks', 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2299: {
        1300: ['Rebecca', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1306: ['Sugar', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2292: ['Vivi',  0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2297: ['Perona', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2295: ['Moria', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2299: ['Hancock', 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2336: {
        1004: ['Sachi & Penguin', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1532: ['Usopp', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1593: ['Gear 4', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1749: ['Bepo', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1412: ['Chopper', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2336: ['Law', 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2387: {
        418: ['Doffy', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
       1091: ['X Drake', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
       1830: ['Caesar', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
       2230: ['Sheepshead', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
       2231: ['Jack',  4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
       2387: ['Kaido', 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2362: {
    ...
    2469: {
        ...
        '</span>', 1200000, 5300, 1, 0.1, 0.05]
    },
    2443: {
        1401: ['Gladius', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1902: ['Pica', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1906: ['Sugar', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2144: ['Diamante', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2443: ['Doflamingo', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2510: {
         836: ['Kuma', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1445: ['Hancock', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2277: ['Buggy',  0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2475: ['Mihawk', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2510: ['Weevil', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2557: {
         860: ['Coby', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1192: ['Aokiji', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1780: ['Kizaru', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2197: ['Blackbeard', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1314: ['Akainu', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2557: [['Shanks & ', 'Beckman'], 5, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2583: {
         963: ['Charlos', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
         964: ['Roswald', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1595: ['Fujitora', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2340: ['Stussy', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2583: ['Lucci', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2618: {
         927: ['Doberman', 0, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        1320: ['Tsuru', 2, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2251: ['Garp', 3, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2605: ['Coby', 1, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0],
        2618: [['Sakazuki & ', 'Issho'], 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
    },
    2659: {
    ...
    2197: {
        ...
        2197: ['TBD', 4, '<span class="tooltiptext">TBD</span>', 0, 0, 0, 0, 0]
   },
    9999: [
        ['',            ''],
        ['',            ''],
